...
// Updated Overlays with consistent structure and onClose prop handling
const Overlays = {
  bean: ({ onClose }) => (
    <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-lg shadow-xl max-w-md">
      ...
      <p className="text-gray-700 mb-4">
        The iconic Cloud Gate sculpture, affectionately known as The Bean, is one of Chicago's most 
        popular attractions. This stunning piece of public art provides a unique reflection of the city skyline.
      </p>
  ...
  willis: ({ onClose }) => (
    <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-lg shadow-xl max-w-md">
      ...
      <p className="text-gray-700 mb-4">
        Step out onto The Ledge — glass boxes extending 4.3 feet out from the 103rd floor. 
        Experience breathtaking views of Chicago from 1,353 feet in the air.
      </p>
  ...
  navyPier: ({ onClose }) => (
    <div className="bg-gradient-to-br from-cyan-50 to-white p-6 rounded-lg shadow-xl max-w-md">
      ...
      <p className="text-gray-700 mb-4">
        A 3,300-foot-long pier packed with entertainment, restaurants, and attractions. 
        Home to the iconic Centennial Wheel and stunning views of Lake Michigan.
      </p>
